...
class ShopifyCore {
  public  $version	= '2017-04-14';
  public  $name     = 'ShopifyClient';
  ...
  public  $shop_domain;
	...
	private function curlSetopts( $ch, $method, $payload, $request_headers ){
		...
		curl_setopt( $ch, CURLOPT_USERAGENT, $this->name . '-php-api' );
    ...
    list(, $headers['http_status_code'], $headers['http_status_message'] )
      = explode( ' ', trim( array_shift( $header_lines ) ), 3 );
	...
	private function shopApiCallLimitParam( $index ){
		if ( NULL == $this->last_response_headers ){
